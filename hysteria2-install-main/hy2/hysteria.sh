...
inst_site(){
    read -rp "请输入 Hysteria 2 的伪装网站地址 （去除https://） [默认牛津大学]：" proxysite
    [[ -z $proxysite ]] && proxysite="www.ox.ac.uk"
...
insthysteria(){
    ...
    wget -N https://raw.githubusercontent.com/chaos-zhu/hy/refs/heads/main/hysteria2-install-main/hy2/install_server.sh
